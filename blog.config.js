...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '勇哥小站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '勇哥的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vercel.com/dashboard', // 网站地址
